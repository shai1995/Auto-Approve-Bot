    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                ...
                InlineKeyboardButton("• ᴜᴩᴅᴀᴛᴇꜱ •", url="https://telegram.me/MRADBOT_OFFICIALS"),
                InlineKeyboardButton("• ꜱᴜᴩᴩᴏʀᴛ •", url="https://telegram.me/MRADBOT_OFFICIALS")
            ],[
